...
var Agent = (function () {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (Array.isArray(payload)) {
                        payload = payload
                            .map(function (p) { return lodash_1.omit(p, allUrlParamKeys.concat(queryParamKeys)); });
                    }
                    else {
    ...
    Agent.prototype.requestWithParams = function (_a) {
        var method = _a.method, path = _a.path, payload = _a.payload, urlParams = _a.urlParams, queryParams = _a.queryParams, catchNotFound = _a.catchNotFound, payloadKey = _a.payloadKey, returnResourceIdInLocationHeader = _a.returnResourceIdInLocationHeader, payloadFormat = _a.payloadFormat;
                    ...
                    case 0:
                        ...
                        if (method === 'GET') {
                            ...
                            if (!payloadFormat || payloadFormat === 'json') {
                                ...
                                requestConfig.data = querystring_1["default"].stringify(payload);
                            }
                        }
                        if (queryParams) {
    ...
    Agent.prototype.transformKeys = function (payload, keyMapping) {
        var _this = this;
        if (!payload) {
            return;
        }
        if (Array.isArray(payload)) {
            payload.forEach(function (p) { return _this.transformKey(p, keyMapping); });
        }
        else {
