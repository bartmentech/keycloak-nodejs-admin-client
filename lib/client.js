...
var permission_1 = require("./resources/permission");
...
var protectedResource_1 = require("./resources/protectedResource");
var KeycloakAdminClient = (function () {
    function KeycloakAdminClient(connectionConfig) {
        ...
        this.permissions = new permission_1.Permissions(this);
        this.authorization = new authorization_1.Authorization(this);
        this.protectedResource = new protectedResource_1.ProtectedResource(this);
    }
