...
export interface AuthorizationRequest {
     ...
     * extension to urn:ietf:params:oauth:grant-type:uma-ticket grant type in order to allow clients to send
     * authorization requests without a permission ticket. The format of the string must be: RESOURCE_ID#SCOPE_ID.
